...
def summarize_from_text(text_for_processing):
    api_key = os.environ.get('SUMMARIZE_BOT_KEY')
    post_body = bytes(text_for_processing.encode('utf-8'))

    api_url = f"https://www.summarizebot.com/api/summarize?apiKey={api_key}&size=20&keywords=10&fragments=15"
